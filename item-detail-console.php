...
<?php
  ...
  if ($post_id == "") {
    ...
    $sql = "SELECT * FROM console WHERE id_console = $post_id";
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<dl id="editbtn" class="dl-horizontal">
                                ...
                                <dt>&nbsp;</dt>
                                <input type="text" hidden="hidden" name="itemid"  value="<?=$console; ?>">
                            ...
                            <div id="kapaa">
	                           ...
	                           <br>                         
                                ...
                                <form method="post" action="processor/updateconsole.php">
                                <input type="text" hidden="hidden" name="itemid"  value="<?=$console; ?>">
                                ...
                                <form method="post" action="processor/deleteconsole.php">  
                                <input hidden="hidden" type="text" name="iddelete" value="<?=$console?>">
                            ...
                            <a href="console.php"><button class="btn btn-danger">Back</button></a> 
                            </div>
						</div>
					</div>
