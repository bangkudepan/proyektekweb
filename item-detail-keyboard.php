...
<?php
  ...
  if ($post_id == "") {
    ...
    $sql = "SELECT * FROM keyboard WHERE id_keyboard = $post_id";
  $result = $conn->query($sql);
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        $keyboard = $row['id_keyboard'];
        $namaitem = $row['nama'];
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<dl id="editbtn" class="dl-horizontal">
                                ...
                                <dt>&nbsp;</dt>
                                <input type="text" hidden="hidden" name="itemid"  value="<?=$keyboard; ?>">
                            ...
                            <div id="kapaa">
	                           ...
	                           <br>                         
                                ...
                                <form method="post" action="processor/updatekeyboard.php">
                                <input type="text" hidden="hidden" name="itemid"  value="<?=$keyboard; ?>">
                                ...
                                <form method="post" action="processor/deletekeyboard.php">  
                                <input hidden="hidden" type="text" name="iddelete" value="<?=$keyboard?>">
                            ...
                            <a href="keyboard.php"><button class="btn btn-danger">Back</button></a> 
                            </div>
						</div>
					</div>
