...
<?php
  ...
  if ($post_id == "") {
    ...
    $sql = "SELECT * FROM mouse WHERE id_mouse = $post_id";
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<dl id="editbtn" class="dl-horizontal">
                                ...
                                <dt>&nbsp;</dt>
                                <input type="text" hidden="hidden" name="itemid"  value="<?=$mouse; ?>">
                            ...
                            <div id="kapaa">
	                           ...
	                           <br>                         
                                ...
                                <form method="post" action="processor/updatemouse.php">
                                <input type="text" hidden="hidden" name="itemid"  value="<?=$mouse; ?>">
                                ...
                                <form method="post" action="processor/deletemouse.php">  
                                <input hidden="hidden" type="text" name="iddelete" value="<?=$mouse?>">
                            ...
                            <a href="mouse.php"><button class="btn btn-danger">Back</button></a> 
                            </div>
						</div>
					</div>
